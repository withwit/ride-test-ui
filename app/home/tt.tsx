      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-200 to-cyan-100 flex items-center justify-center p-4">
        ...
        <div className="relative z-10 grid grid-cols-3 gap-6 w-full max-w-7xl">
          ...
          <div className="bg-white bg-opacity-40 backdrop-blur-md p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <button className="w-full py-2 bg-gradient-to-r from-green-300 to-transparent text-black-100 font-bold rounded shadow-md">
              Create Ride
            </button>
          ...
          <div className="bg-white bg-opacity-40 backdrop-blur-md p-6 rounded-xl shadow-lg border border-gray-200">
            ...
            <div>
              ...
              <button className="w-full py-2 mb-2 bg-gradient-to-r from-red-200 to-white-200 text-black-100 font-bold rounded shadow-md">
                Ride Request 1
              </button>
              <button className="w-full py-2 bg-gradient-to-r from-red-200 to-white-200 text-black-100 font-bold rounded shadow-md">
                Ride Request 2
              </button>
            </div>
          </div>
